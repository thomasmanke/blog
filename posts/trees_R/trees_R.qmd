...
Use the `Titanic` data set to visualize the number of survivors in the various categories: Class -\> Sex -\> Age.

Define IDs and parent-IDs for each cell in this hierarchy: Survival/Class/Sex/Age.
